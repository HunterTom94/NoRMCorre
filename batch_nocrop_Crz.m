...
options_nonrigid = NoRMCorreSetParms('d1',size(Y,1),'d2',size(Y,2),'grid_size',[gridsize,gridsize],'overlap_pre',[overlap_pre,overlap_pre] ,'mot_uf',4,'overlap_post',[overlap_post,overlap_post],'bin_width',25,'max_shift',50,'max_dev',20,'us_fac',150);

try
    tic; [M2,shifts2,template2,options_nonrigid] = normcorre_batch(Y,options_nonrigid,Y(:,:,500)); toc
    counter = counter + 1;
catch e
