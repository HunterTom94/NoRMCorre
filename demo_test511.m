...
name = 'C:\Lab\#Yinan\ROI Extraction\511_test.tif';
...
options_nonrigid = NoRMCorreSetParms('d1',size(Y,1),'d2',size(Y,2),'grid_size',[25,25],'overlap_pre',[10,10] ,'mot_uf',4,'overlap_post',[10,10],'bin_width',50,'max_shift',20,'max_dev',5,'us_fac',50,'init_batch',150);
tic; [M2,shifts2,template2,options_nonrigid] = normcorre_batch(Y,options_nonrigid); toc

% saveastiff(M1,'C:\Lab\#Yinan\ROI Extraction\Test Videos\New folder (2)\477_test_rig_3.tif')
% saveastiff(M2,'C:\Lab\#Yinan\ROI Extraction\Test Videos\New folder (2)\511_test_els_1.tif')
%% compute metrics
