...
% name = 'C:\Users\Wang Lab\Desktop\temp\659_late.tif';
 ...
 Y = read_file(name);  % read the file (optional, you can also pass the path in the function instead of Y)
...
%         end
        ...
        [M2,shifts2,template2,options_nonrigid] = normcorre_batch(crop,options_nonrigid); 
